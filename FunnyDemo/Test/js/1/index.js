(function () {
    ...
    //fpart
    var _fp2 = document.getElementById("f-part2");
    var _fp2Input = _fp2.getElementsByTagName('input')[0];
    ...
    function createText(t) {
        ...
        //Go next Page!
        setTimeout(function () {
            document.getElementById("f-part1").style.display = "none";
            _fp2.style.display = "";
            _fp2Input && (_fp2Input.className = "btn-next g-next");
        }, 800);
    }
